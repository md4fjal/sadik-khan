    ...
    <div id="about" className="scroll-mt-24">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          <div className="aspect-square glass-dark rounded-[2rem] border border-foreground/10 overflow-hidden relative group">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-12">
              ...
              <div className="grid grid-cols-3 gap-4 w-full h-full opacity-30">
                {Array.from({ length: 9 }).map((_, i) => (
                  <div
                    key={i}
                    className="border border-foreground/10 rounded-lg flex items-center justify-center"
                  >
                    {i % 2 === 0 && (
          ...
          {/* Floating badge */}
          <div className="absolute -top-6 -right-6 p-4 glass rounded-2xl border border-foreground/10 animate-bounce-slow">
